    ...
    const getProductDetail = async () => {
      try {
        ...
        const result = await axios.get(
          `${homeAPI}/product/admin/detail/${product_id}`
        );
        ...
        setProductVariantList(
          await convertProductVariantList(
            fakeProductDetail.product_variant_list
          )
        );
      }
    };
    ...
    if (Validate()) {
      try {
        ...
        let result = await axios.put(
          `${homeAPI}/product/update`,
          updateProduct
        );
        console.log(result.data);
        for (let productVariant of productVariantList) {
          let dataProductVariant = new FormData();
          dataProductVariant.append(
            "product_variant_id",
  ...
  return (
    <div className="update-product-page">
      ...
      <div className="update-product-form">
        ...
        <div className="row">
          <div className="col-6">
            <label htmlFor="product-name" className="fw-bold">
              Tên sản phẩm:
            </label>
            <Input
              id="product-name"
        ...
        <div className="row">
          <div className="col-6">
            <label htmlFor="product-category" className="fw-bold">
              Danh mục:
            </label>
            <Category
          ...
          <div className="col-6">
            <label htmlFor="product-price" className="fw-bold">
              Giá sản phẩm:
            </label>
            <br />
            <InputNumber
        ...
        <div>
          <label htmlFor="enter-name" className="fw-bold">
            Danh sách lựa chọn:
          </label>
          <table className="table w-100 table-hover align-middle table-bordered">
            <thead>
              <tr className="row-product-variant">
                <th className="col-colour text-center" scope="col">
                  Màu
                </th>
                <th className="col-size text-center" scope="col">
                  Size
                </th>
                <th className="col-quantity text-center" scope="col">
                  Tồn kho
                </th>
                <th className="col-image text-center" scope="col">
                  Ảnh
                </th>
