      ...
      <div className="homepage-basic container-fluid g-0">
        <div className="row g-0">
          ...
          <div className="homepage-basic-right col-7 position-relative">
            <Image
              src={"/img/homepage/imgHomepageBasic.jpg"}
              fill
        ...
        <div className="row">
          <div className="col">
            <div className="homepage-brands-img position-relative">
              <Image
                src={"/img/homepage/homepageBrandsLeft.jpg"}
                fill
                alt="homepage-brands-left"
              />
          ...
          <div className="col">
            <div className="homepage-brands-img position-relative">
              <Image
                src={"/img/homepage/homepageBrandsRight.jpg"}
                fill
                alt="homepage-brands-right"
              />
              <div className="homepage-brands-content position-absolute">
                <h2>CM24</h2>
                <p>
        ...
        <div className="row">
          <div className="col">
            <div className="homepage-service-item position-relative">
              <Image
                src={"/img/homepage/homepageServiceLeft.jpg"}
                fill
                alt="homepage-service-left"
              />
          ...
          <div className="col">
            <div className="homepage-service-item position-relative">
              <Image
                src={"/img/homepage/homepageServiceRight.jpg"}
                fill
                alt="homepage-service-right"
              />
              <div className="homepage-service-content d-flex justify-content-between align-items-center w-100">
